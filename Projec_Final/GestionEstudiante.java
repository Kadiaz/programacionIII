...
public class GestionEstudiantes {
    ...
    public Estudiante eliminarEstudiante(String idP) throws EstudianteNoEncontradoException {
        ...
        System.out.println("🗑️ Estudiante " + estudianteEliminado.getNombre() + " eliminado.");
        return estudianteEliminado; // lo retornamos para guardarlo en la pila de deshacer
    }

    // Getter del mapa (útil para el sistema deshacer)
